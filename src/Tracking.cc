...
Tracking::Tracking(System *pSys, ORBVocabulary* pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Map *pMap, shared_ptr<PointCloudMapping> pPointCloud, KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor):
    ...
    mpKeyFrameDB(pKFDB), mpInitializer(static_cast<Initializer*>(NULL)), mpSystem(pSys),  mpViewer(NULL), //  mpViewer(NULL) 추가
...
void Tracking::Track()
{
    ...
    if(mState==NO_IMAGES_YET || mState==WAIT)
    {
    ...
    else
    {
        ...
        if(bOK)
        {
            ...
            // cout << "CreateNewKeyFrame end CreateNewKeyFrame end" << endl;
        ...
        // cout << "tracking were good, check if we insert a keyframe" << endl;
...
void Tracking::CreateNewKeyFrame()
{
    ...
    // cout << "KeyFrame KeyFrame KeyFrame KeyFrame" << endl;
    ...
    if(mSensor!=System::MONOCULAR)
    {
        ...
        // cout << "mCurrentFrame update complete" << endl;
        // cout << " empty : " << vDepthIdx.empty() << endl;
    ...
    // cout << "Finished KeyFrame" << endl;

    mpLocalMapper->InsertKeyFrame(pKF);

    // cout << "Finished InsertKeyFrame" << endl;

    mpLocalMapper->SetNotStop(false);

    // cout << "Finished SetNotStop" << endl;

    vector<KeyFrame*> vpKFs = mpMap->GetAllKeyFrames();

    cout << "Finished GetAllKeyFrames" << endl;
	// insert Key Frame into point cloud viewer
    mpPointCloudMapping->insertKeyFrame( pKF, this->mImRGB, this->mImDepth, pKF->mnId, vpKFs );

    cout << "Finished insert Key Frame into point cloud viewer" << endl;
...
// Fixed by Taeyoung
void Tracking::ResetLocalMapping()
{
    // Reset Local Mapping
    // cout << "Reseting Local Mapper... of thread " << mId << endl;
